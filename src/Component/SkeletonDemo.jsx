...
const SkeletonDemo = () => {
  return (
    <>  
        <div role="status" className=" w-[185px] md:w-[270px] shadow-xs animate-pulse ">
            <div role="status" className="flex items-center justify-center h-48 max-w-sm bg-hide rounded-base animate-pulse mb-4 sm:mb-6">
            ...
            <div className="h-2.5 bg-hide rounded-full w-48 mb-4" />
            <div className="h-2 bg-hide rounded-full mb-2.5" />
            <div className="h-2 bg-hide rounded-full mb-2.5" />
            <div className="h-2 bg-hide rounded-full" />
        </div>
