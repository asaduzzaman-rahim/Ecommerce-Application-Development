        ...
        <div className='w-[270px] group'>
            <div className='relative overflow-hidden '>
                ...
                <div className='absolute top-[14px] right-[14px]'>
                  <span className='text-[26px] leading-[18px]  mb-[8px] text-black cursor-pointer'>{Icon1}</span>
                  <span className=' text-[26px] leading-[18px]  mb-[8px] text-black cursor-pointer'>{Icon2}</span>
                </div>
