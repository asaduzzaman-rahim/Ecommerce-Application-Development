...
const IconCart = ({IconImg, Num, para}) => {
  return (
    <div className="px-[40px] py-[30px]  border-1 border-gray-500 rounded-[20px] text-center group hover:bg-[#DB4444]" >
      <img className='h-[58px] w-[58px] mx-auto bg-black rounded-full border-6 border-[#363738] group-hover:border-white group-hover:bg-red-500 group-hover:text-[#0000] ' src={IconImg} alt="Icon Img" />
